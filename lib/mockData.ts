...
export const SERVICES = [
  ...
  { code: "CS200038", name: "독서실" },
  { code: "CS200039", name: "DVD방" },
  { code: "CS200040", name: "녹음실" },
  { code: "CS200041", name: "사진관" },
  { code: "CS200042", name: "통번역서비스" },
  { code: "CS200043", name: "건축물청소" },
  { code: "CS200044", name: "여행사" },
  { code: "CS200045", name: "비디오/서적임대" },
  { code: "CS200046", name: "의류임대" },
  { code: "CS200047", name: "가정용품임대" },
  { code: "CS300001", name: "슈퍼마켓" },
  { code: "CS300002", name: "편의점" },
  { code: "CS300003", name: "컴퓨터및주변장치판매" },
  { code: "CS300004", name: "핸드폰" },
  { code: "CS300005", name: "주류도매" },
  ...
  { code: "CS300030", name: "중고가구" },
  { code: "CS300031", name: "가구" },
  { code: "CS300032", name: "가전제품" },
  { code: "CS300033", name: "철물점" },
  { code: "CS300034", name: "악기" },
  { code: "CS300035", name: "인테리어" },
  { code: "CS300036", name: "조명용품" },
  { code: "CS300037", name: "중고차판매" },
  { code: "CS300038", name: "자동차부품" },
  { code: "CS300039", name: "모터사이클및부품" },
  { code: "CS300040", name: "재생용품 판매점" },
  { code: "CS300041", name: "예술품" },
  { code: "CS300042", name: "주유소" },
